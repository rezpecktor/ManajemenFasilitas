...
CREATE TABLE `siswa` (
  ...
  `kondisi` enum('service','ganti') NOT NULL,
  `ruangan` enum('RA','RB','RC','RD','RM','GR') NOT NULL,
...
INSERT INTO `siswa` (`nis`, `nama`, `lokasi`, `tanggal`, `kondisi`, `ruangan`, `email`, `gambar`, `alamat`) VALUES
