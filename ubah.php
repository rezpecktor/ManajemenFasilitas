          ...
          <div class="row my-2 text-light">
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              <label for="nis" class="form-label">No</label>
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="ruangan" name="ruangan">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Ruangan--------------------------------------------</option>
                                   <option value="RA" <?php if ($siswa['ruangan'] == 'RA') { ?>
                                        selected='' <?php } ?>>RA</option>
                                   <option value="RB"
                                        <?php if ($siswa['ruangan'] == 'RB') { ?> selected=''
                                        <?php } ?>>RB</option>
                                   <option value="RC" <?php if ($siswa['ruangan'] == 'RC') { ?>
                                        selected='' <?php } ?>>RC</option>
                                   <option value="RD"
                                        <?php if ($siswa['ruangan'] == 'RD') { ?> selected=''
                                        <?php } ?>>RD</option>
                                   <option value="RM" <?php if ($siswa['ruangan'] == 'RM') { ?>
                                        selected='' <?php } ?>>RM</option>
                                   <option value="GR" <?php if ($siswa['ruangan'] == 'GR') { ?> selected=''
                                        <?php } ?>>GR</option>
                              </select>
                         </div>
                         <div class="mb-3">
