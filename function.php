<?php
// Koneksi Database
$koneksi = mysqli_connect("localhost", "root", "", "tugasweb4");
...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$nis','$nama','$lokasi','$tanggal','$kondisi','$ruangan','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', lokasi = '$lokasi', tanggal = '$tanggal', kondisi = '$kondisi', ruangan = '$ruangan', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nis = $nis";
